...
pre : " <b> 5.2. </b> "
---
### 1. Thiết lập các Role với quyền hạn tối thiểu bằng AWS IAM.
...
#### 1.1. Nhóm Backend: Chịu trách nhiệm xử lý các nghiệp vụ của ứng dụng và được cấp quyền đọc/ghi dữ liệu trên cơ sở dữ liệu Amazon Aurora PostgreSQL.

##### Tạo IAM Policy (Chính sách cấp quyền truy cập Database).

![IAM_RDS](images/IAM_RDS_1.png)

<div align="center"><i>Hình 2.1: Tạo policy tự cấu hình bằng JSON.</i></div>
...
<div align="center"><i>Hình 2.2: Đặt tên và xác nhận policy.</i></div>

##### Tạo IAM Role cho Backend.

![IAM_RDS](images/IAM_RDS_3.png)

<div align="center"><i>Hình 2.3: Chọn dịch vụ được cấp phép truy cập database.</i></div>

Vì database được xử lý thông qua các hàm Lambda nên ta chọn Service Use Case Lambda.

![IAM_RDS](images/IAM_RDS_4.png)

<div align="center"><i>Hình 2.4: Thêm policy cho Role này.</i></div>
...
<div align="center"><i>Hình 2.5: Đặt tên và xác nhận role.</i></div>

#### 1.2. Nhóm Thực thi bảo trì database: Phụ trách các tác vụ bảo trì định kỳ của cơ sở dữ liệu, bao gồm đặt lại tiến trình thế giới hằng ngày và thực hiện lệnh `VACUUM` để dọn dẹp dữ liệu không còn sử dụng, góp phần duy trì hiệu năng của hệ thống.
...
<div align="center"><i>Hình 2.6: Đặt tên và xác nhận policy.</i></div>

![IAM_Maintenance](images/IAM_Maintenance_2.png)

<div align="center"><i>Hình 2.7: Đặt tên và xác nhận role.</i></div>

#### 1.3. Điều phối luồng API: Can thiệp vào các biến môi trường của Amazon API Gateway nhằm thực hiện việc mở hoặc đóng cổng truy cập hệ thống khi cần thiết.
...
<div align="center"><i>Hình 2.8: Đặt tên và xác nhận policy.</i></div>

![IAM_API_Traffic](images/IAM_API_Traffic_2.png)

<div align="center"><i>Hình 2.9: Đặt tên và xác nhận role.</i></div>

---

### 2. Quản lý chi phí bằng AWS Budgets.

#### 2.1. Tính toán chi phí vận hành.
...
<div align="center"><i>Hình 2.10: Biểu đồ tỉ lệ chi phí dịch vụ.</i></div>

#### 2.2. Thiết lập hạn mức cho AWS Budgets.

##### Budget 1: Tính toán tổng chi phí vận hành của toàn bộ hệ thống.

![Budget](images/Budget_1.png)

<div align="center"><i>Hình 2.11: Thiết lập cấu hình Cost Budget.</i></div>

![Budget](images/Budget_2.png)

<div align="center"><i>Hình 2.12: Thiết lập thông số Cost Budget.</i></div>

Hạn mức 140 USD cố định hàng tháng.

![Budget](images/Budget_3.png)

<div align="center"><i>Hình 2.13: Thiết lập cảnh cáo sớm (dự báo).</i></div>

![Budget](images/Budget_4.png)

<div align="center"><i>Hình 2.14: Thiết lập cảnh cáo thực tế (gần chạm trần).</i></div>

![Budget](images/Budget_5.png)

<div align="center"><i>Hình 2.15: Thiết lập cảnh cáo khẩn cấp (vượt trần).</i></div>

![Budget](images/Budget_6.png)

<div align="center"><i>Hình 2.16: Xác nhận và hoàn tất tạo Cost Budget.</i></div>

##### Budget 2: Giám sát Aurora DB.

![Budget](images/Budget_7.png)

<div align="center"><i>Hình 2.17: Thiết lập cấu hình Usage Budget.</i></div>

![Budget](images/Budget_8.png)

<div align="center"><i>Hình 2.18: Thiết lập thông số Usage Budget.</i></div>

Hệ thống 2 ACU chạy 24/7, 1 tháng cần khoảng 1460 ACU-Hrs.

![Budget](images/Budget_9.png)

<div align="center"><i>Hình 2.19: Thiết lập cảnh cáo thực tế.</i></div>

![Budget](images/Budget_10.png)

<div align="center"><i>Hình 2.20: Thiết lập cảnh cáo thực tế khẩn cấp.</i></div>

![Budget](images/Budget_11.png)

<div align="center"><i>Hình 2.21: Xác nhận và hoàn tất tạo Usage Budget.</i></div>

### 3. Khởi tạo lớp biên mạng.
...
<div align="center"><i>Hình 2.22: Tạo CloudFormation Stack và nạp file network-security-stack.yaml vào.</i></div>

![Network_Security_Stack](images/Network_Security_Stack_2.png)

<div align="center"><i>Hình 2.23: Đặt tên và truyền endpoint.</i></div>
...
<div align="center"><i>Hình 2.24: Xác nhận và Submit.</i></div>

![Network_Security_Stack](images/Network_Security_Stack_4.png)

<div align="center"><i>Hình 2.25: Kiểm tra lại thành phần đã tạo.</i></div>
